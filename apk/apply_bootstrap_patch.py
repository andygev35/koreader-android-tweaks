...
REPLACEMENT = (
    ...
    '            -- (unlike 2-color-schemes-css.lua, deliberately left out\n'
    '            -- of this list, which stays untouched by design). Runs\n'
    '            -- once per device, gated by a marker file, and backs up\n'
    '            -- whatever it replaces rather than dropping it silently,\n'
    '            -- in case a legacy copy actually was hand-edited.\n'
    '            local LEGACY_MIGRATE_FILES = {\n'
    '                ["2-extra-dim.lua"] = true,\n'
    '                ["2-night-mode-links.lua"] = true,\n'
    '            }\n'
